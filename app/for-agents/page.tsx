    ...
    <>
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#1B2A6B] text-center mb-12">How It Works</h2>
          <div className="max-w-4xl mx-auto space-y-6">
            {[
              ...
              <div key={index} className="bg-[#FAFAFA] p-8 rounded-lg">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#1B2A6B] text-center mb-12">What Your Clients Get</h2>
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-[#1B2A6B] text-center mb-12">Register as a DIGG Partner Agent</h2>
          <AgentForm />
        </div>
      </section>
    </>
