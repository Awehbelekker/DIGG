  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-[#152232] mb-4">DIGG Architecture</h1>
        <p className="text-lg text-gray-600 mb-8">
          Cape Town architecture practice built on one idea: great design should generate real returns.
        </p>
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-[#152232] mb-4">Your Property Should Be Working Harder.</h2>
