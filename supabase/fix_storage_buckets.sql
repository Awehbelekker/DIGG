-- Safe-to-rerun: creates storage buckets and RLS policies for image uploads.
...
-- 3. Authenticated upload (INSERT) policies
...
-- 4. Authenticated update policies
...
-- 5. Authenticated delete policies
