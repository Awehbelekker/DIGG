      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            ...
            className="bg-[#F7941D] text-white px-8 py-3 rounded font-semibold hover:bg-[#e6850a] transition-colors text-center"
          >
            {primaryCTA.text}
          </Link>
          <Link
            href={secondaryCTA.href}
            className="bg-transparent border-2 border-white text-white px-8 py-3 rounded font-semibold hover:bg-white hover:text-[#1B2A6B] transition-colors text-center"
          >
            {secondaryCTA.text}
          </Link>
        </div>
